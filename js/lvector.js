...
lvector.Layer = L.Class.extend({
    ...
    setMap: function(a) {
        ...
        if (this.options.map) this._hide(), this.options.map = a
    },
    getMap: function() {
    ...
    _hideVectors: function() {
        for (var a = 0; a < this._vectors.length; a++) {
            ...
            if (this.popup && this.popup.associatedFeature && this.popup.associatedFeature == this._vectors[a]) this.options.map.removeLayer(this.popup), this.popup = null;
...
lvector.GitSpatial = lvector.GeoJSONLayer.extend({
    ...
    setFeatureSet: function(s) {
        this.options.featureSet = s;
    },
    _getFeatures: function() {
